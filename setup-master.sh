...
echo "mysql -uroot -p$MYSQL_ROOT_PASSWORD -e \"CHANGE MASTER TO MASTER_HOST='master', MASTER_PORT=3306, MASTER_USER='repl_user', MASTER_PASSWORD='repl_pass', MASTER_LOG_FILE='mysql-bin.000002', MASTER_LOG_POS=3041454;\"" | tee /shared/master_status.sql
